...
var file_proto_users_users_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x16, 0x67, 0x6f, 0x2e, 0x6d, 0x69,
	...
	0x6b, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x73, 0x74, 0x72, 0x6f, 0x6b, 0x65,
	0x32, 0x85, 0x02, 0x0a, 0x05, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x4b, 0x0a, 0x04, 0x43, 0x61,
	...
	0x76, 0x69, 0x63, 0x65, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61,
	...
	0x73, 0x65, 0x72, 0x73, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x52, 0x65,
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x50, 0x6f,
...
var file_proto_users_users_proto_goTypes = []interface{}{
	...
	(*Request)(nil),           // 1: go.micro.service.users.Request
	(*Response)(nil),          // 2: go.micro.service.users.Response
	(*StreamingRequest)(nil),  // 3: go.micro.service.users.StreamingRequest
	(*StreamingResponse)(nil), // 4: go.micro.service.users.StreamingResponse
	(*Ping)(nil),              // 5: go.micro.service.users.Ping
	(*Pong)(nil),              // 6: go.micro.service.users.Pong
}
var file_proto_users_users_proto_depIdxs = []int32{
	1, // 0: go.micro.service.users.Users.Call:input_type -> go.micro.service.users.Request
	3, // 1: go.micro.service.users.Users.Stream:input_type -> go.micro.service.users.StreamingRequest
	5, // 2: go.micro.service.users.Users.PingPong:input_type -> go.micro.service.users.Ping
	2, // 3: go.micro.service.users.Users.Call:output_type -> go.micro.service.users.Response
	4, // 4: go.micro.service.users.Users.Stream:output_type -> go.micro.service.users.StreamingResponse
	6, // 5: go.micro.service.users.Users.PingPong:output_type -> go.micro.service.users.Pong
